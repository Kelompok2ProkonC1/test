...
<head>
	...
	<title>SPP Desa Telukagung</title>
	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				...
				<span class="brand-text"> SPP TELUKAGUNG</span>
			</a>
			...
			<div class="sidebar">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<!-- Level  -->
						<?php
          if ($data_level=="Administrator"){   //Tampilan Hanya Untuk Administrator
        ?>
...
<!-- Sidebar user (optional) -->
				...
				<button type="submit" class="btn btn-danger btn-block " name="btnLogout" title="Keluar Sistem">
					<a onclick="return confirm('Apakah anda yakin akan keluar ?')" href="logout.php" class="nav-link">
						<i class="nav-icon fas fa-arrow-circle-right"><b> Logout</b></i>
					</a>
				</button>
			</div>
			<!-- /.sidebar -->
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
				...
				case 'view-pend':
					...
					break;
				case 'data-laki':
					include "admin/pend/data-laki.php";
					break;
				case 'data-perempuan':
					include "admin/pend/data-perempuan.php";
					break;
