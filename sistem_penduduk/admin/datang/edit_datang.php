<?php
    ...
    if(isset($_GET['kode'])){
        $sql_cek = "SELECT d.id_datang, d.nik, d.nama_datang, d.jekel, d.tgl_datang, d.status_tinggal, p.id_pend, p.nama from 
...
<div class="card card-success">
	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Status datang</label>
				<div class="col-sm-3">
					<select name="jekel" id="jekel" class="form-control">
						<option value="">-- Pilih --</option>
						<?php
                //mengecek data yg dipilih sebelumnya
                if ($data_cek['status_tinggal'] == "Tetap") echo "<option value='Tetap' selected>Tetap</option>";
                else echo "<option value='Tetap'>Teta</option>";

                if ($data_cek['status_tinggal'] == "Sementara") echo "<option value='Sementara' selected>Sementara</option>";
                else echo "<option value='Sementara'>Sementara</option>";
            ?>
					</select>
				</div>
			</div>
