			...
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">kepala Keluarga</label>
					...
					<select name="kepala" id="kepala" class="form-control select2bs4" required>
                        ...
                        $query = "select k.id_kk, k.no_kk, p.nama as kepala from tb_kk k left join tb_pdd p on p.id_pend = k.kepala"; // mengambil data penduduk
						...
						<?php if($row['id_kk'] == $data_cek['id_kk'] ){ // memilih opsi yang ditampilkan/ yang diambil dari database
							echo "selected";
