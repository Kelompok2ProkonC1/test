		...
		<div class="table-responsive">
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					<?php
              $no = 1;
			  $sql = $koneksi->query("SELECT l.id_lahir, l.nama,l.tempat, l.tgl_lh, l.jekel, k.no_kk, p.nama as kepala from 
			  tb_lahir l left join tb_kk k on k.id_kk=l.id_kk left join tb_pdd p on p.id_pend=k.kepala ");
