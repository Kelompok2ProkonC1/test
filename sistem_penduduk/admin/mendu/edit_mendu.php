<?php
    ...
    if(isset($_GET['kode'])){
        $sql_cek = "SELECT p.nama, m.id_mendu, m.tgl_mendu, m.waktu_mendu, m.tempat_mendu, m.sebab FROM 
...
<div class="card card-success">
	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Tgl Meninggal Dunia</label>
				<div class="col-sm-3">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="waktu_mendu" name="waktu_mendu" value="<?php echo $data_cek['waktu_mendu']; ?>"
					 required>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="tempat_mendu" name="tempat_mendu" value="<?php echo $data_cek['tempat_mendu']; ?>"
					 required>
				</div>
			</div>
