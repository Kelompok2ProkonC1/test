	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" class="form-control" id="waktu_mendu" name="waktu_mendu" required>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" class="form-control" id="tempat_mendu" name="tempat_mendu" required>
				</div>
			</div>
...
<?php
    ...
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO tb_mendu (id_pdd, tgl_mendu, waktu_mendu, tempat_mendu, sebab) VALUES (
			'".$_POST['id_pdd']."',
            '".$_POST['tgl_mendu']."',
			'".$_POST['waktu_mendu']."',
			'".$_POST['tempat_mendu']."',
